        ...
        <div class="content-wrapper">
              ...
              <div class="card card-statistics">
                <div class="card-body">
                      ...
                      <div class="fluid-container">
                        <h3 class="font-weight-medium text-right mb-0">
                            <?php
                              ...
                              $this->db->where('month(tgl_pesanan)', $month);
                              $row = $this->db->get()->row();
                              $pendapatan = $row->tot;

                              echo $this->rupiah->setidr($pendapatan);
                            ?>
                        </h3>
                      </div>
                    </div>
                  ...
                  <p class="text-muted mt-3 mb-0">
                    <i class="mdi mdi-calendar mr-1" aria-hidden="true"></i> Periode : <?= date('d M Y')?>
                  </p>
                </div>
              </div>
            </div>
              ...
              <div class="card card-statistics">
                <div class="card-body">
                  <div class="clearfix">
                    ...
                    <div class="float-right">
                      <p class="mb-0 text-right">Total Order</p>
                      <div class="fluid-container">
                        <h3 class="font-weight-medium text-right mb-0">
                          <?php
                              $month = date('m');
                              ...
                              $this->db->where('status', 'Sudah Diterima');
                              $this->db->where('month(tgl_pesanan)', $month);
                              $totalorder = $this->db->get()->num_rows();
              ...
              <div class="card card-statistics">
                <div class="card-body">
                  <div class="clearfix">
                    ...
                    <div class="float-right">
                      <p class="mb-0 text-right">Order Dibatalkan</p>
                      <div class="fluid-container">
                        <h3 class="font-weight-medium text-right mb-0">
                          <?php
                              $month = date('m');
                              $this->db->select('*');
                              $this->db->from('pesanan');
                              $this->db->where('status', 'Di Batalkan');
                              $this->db->where('month(tgl_pesanan)', $month);
                              $totalorder = $this->db->get()->num_rows();
          ...
          <div class="row">
              ...
              <div class="card card-weather">
                <div class="card-body">
                  <div class="weather-date-location">
                    <?php $date = date('D') ?>
                    <h3><?= $this->hari->sethari($date) ?></h3>
                    <p class="text-gray">
                      <span class="weather-date"><?=date('d M,Y')?></span>
                      <span class="weather-location">Jakarta, Indonesia</span>
                    </p>
                  </div>
            ...
            <div class="col-lg-5 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h2 class="card-title text-primary mb-5">Riwayat Peforma</h2>
                  <div class="wrapper d-flex justify-content-between">
                    <div class="side-left">
                      <p class="mb-2">Peforma Terbaik</p>
                  ...
                  <div class="wrapper d-flex justify-content-between">
                    <div class="side-left">
                      <p class="mb-2">Performa Terburuk</p>
