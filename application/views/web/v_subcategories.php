        ...
        <div class="col product_section clearfix">
            ...
            <div class="breadcrumbs d-flex flex-row align-items-center">
                <ul>
                    ...
                    <li>
                        <a href="<?=base_url('Product/Categories/')?><?=$kat?>">
                            <i class="fa fa-angle-right" aria-hidden="true"></i>
                            <?=$kat?>
                        </a>
                    </li>
                    <li class="active">
                        <a href="<?=base_url('Product/')?><?=$kat?>/<?=$subkat?>">
                            <i class="fa fa-angle-right" aria-hidden="true"></i>
                            <?=$subkat?>
                        </a>
                    </li>
                ...
                <div class="sidebar_section">
                    ...
                    <ul class="sidebar_categories">
                        <?php foreach ($subcategorie as $sub) { ?>
                            <?php if ($sub->nm_subkategori == $subkat) { ?>
                                <li class="active">
                                    <span>
                            ...
                            <?php } else { ?>
                                <li>
                                    <a href="<?=$sub->nm_subkategori?>"><?=$sub->nm_subkategori?></a>
                                </li>
                            <?php } ?>
                        <?php } ?>
                    </ul>
