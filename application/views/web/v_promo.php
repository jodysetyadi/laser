        ...
        <div class="col product_section clearfix">
            ...
            <div class="breadcrumbs d-flex flex-row align-items-center">
                <ul>
                    ...
                    <li class="active">
                        <a href="<?=base_url('Product/Promo')?>">
                            <i class="fa fa-angle-right" aria-hidden="true"></i>Promo
                        </a>
                    </li>
                </ul>
            </div>
                ...
                <div class="sidebar_section">
                    ...
                    <ul class="sidebar_categories">
                        <?php foreach ($categories as $cat) { ?>
                            <li>
                                <a href="<?=base_url('Product/Categories/')?><?=$cat->nm_kategori?>"><?=$cat->nm_kategori?>
                                </a>
                            </li>
                        <?php } ?>
                    </ul>
                                ...
                                <?php foreach ($product as $p) : ?>
                                        ...
                                        <?php if ($p->diskon == NULL) { ?>
                                            ...
                                            <div class="product-item men">
                                                ...
                                                <div class="red_button add_to_cart_button"><a href="<?=base_url('Product/Detailproduct/')?><?=$p->slug?>">Detail</a></div>
                                            </div>
