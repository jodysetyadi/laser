...
<head>
    <title>Shoper | Best Online shop for everything</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="description" content="Shoper Online Shop">
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url('asset/plugins/jquery-ui-1.12.1.custom/jquery-ui.css') ?>">
